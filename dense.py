...
x = keras.layers.Conv2D(32, 5, strides = (2,2), activation='relu')(x)
x = keras.layers.Conv2D(64, 3,activation='relu')(x)
x = keras.layers.MaxPooling2D(pool_size=(2, 2), padding="valid")(x)
x = keras.layers.Conv2D(128, 3,activation='relu', kernel_regularizer=keras.regularizers.L1L2(l1=1e-6, l2=5e-6),activity_regularizer=keras.regularizers.L2(3e-6))(x)
x = keras.layers.Dropout(rate=.17)(x)
x = keras.layers.Conv2D(128, 3,activation='relu', kernel_regularizer=keras.regularizers.L1L2(l1=1e-6, l2=5e-6),activity_regularizer=keras.regularizers.L2(3e-6))(x)
x = keras.layers.MaxPooling2D(pool_size=(2, 2), padding="valid")(x)
x = keras.layers.Flatten()(x)
x = keras.layers.Dropout(rate=.37)(x)
x = keras.layers.Dense(256, activation="swish", kernel_regularizer=keras.regularizers.L1L2(l1=1e-6, l2=5e-6),activity_regularizer=keras.regularizers.L2(3e-6))(x)
x = keras.layers.Dropout(rate=.3)(x)
x = keras.layers.BatchNormalization()(x)
x = keras.layers.Dense(128, activation=keras.activations.leaky_relu, kernel_regularizer=keras.regularizers.L1L2(l1=1e-6, l2=5e-6),activity_regularizer=keras.regularizers.L2(3e-6))(x)
...
x = keras.layers.Dense(32, activation=keras.activations.leaky_relu, kernel_regularizer=keras.regularizers.L1L2(l1=1e-6, l2=5e-6),activity_regularizer=keras.regularizers.L2(3e-6))(x)
...
x = keras.layers.Dense(64, activation="relu", kernel_regularizer=keras.regularizers.L1L2(l1=1e-6, l2=5e-6),activity_regularizer=keras.regularizers.L2(3e-6))(x)
x = keras.layers.Dropout(rate=.51)(x)
x = keras.layers.Dense(32, activation=keras.activations.leaky_relu, kernel_regularizer=keras.regularizers.L1L2(l1=1e-6, l2=5e-6),activity_regularizer=keras.regularizers.L2(3e-6))(x)
x = keras.layers.LayerNormalization()(x)
outputs = keras.layers.Dense(6)(x) #(5 values, fifth for nothing, or either of the previous ones checked)
model = keras.Model(inputs, outputs)
